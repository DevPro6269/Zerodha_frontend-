    ...
    <div>
      ...
      <section className="container flex gap-10 text-lg  text-slate-700 mx-auto justify-center">
        ...
        <div className="flex flex-col gap-5 w-1/3  ">
         ...
         <p><a href="" className="text-blue-800">Rainmatter</a>, our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.</p>
